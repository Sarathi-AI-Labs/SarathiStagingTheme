...
$header_cta = get_field('header_consultation_cta', 'option');
?>
<!doctype html>
	...
	<header class="sarathi-header">
		<div class="sarathi-header-inner sarathi-section-container">
			...
			<div class="sarathi-header-brand">
				<a href="<?php echo esc_url(home_url('/')); ?>" class="sarathi-header-logo-link">
					...
					<img src="<?php echo esc_url($logo_url); ?>" alt="<?php echo esc_attr($logo_alt); ?>"
						class="sarathi-header-logo-icon" />
					<span class="sarathi-header-logo-text">
						<?php echo esc_html($logo_text_display); ?>
					</span>
				</a>
				<button class="sarathi-header-toggle" aria-expanded="false" aria-controls="sarathi-primary-nav"
					aria-label="<?php esc_attr_e('Toggle Navigation', 'custom-theme'); ?>">
			...
			<div class="sarathi-header-nav-container" id="sarathi-primary-nav">
				...
				if (!empty($header_cta) && is_array($header_cta)) {
					$cta_url = !empty($header_cta['url']) ? $header_cta['url'] : $cta_url;
					$cta_text = !empty($header_cta['title']) ? $header_cta['title'] : $cta_text;
					$cta_target = !empty($header_cta['target']) ? $header_cta['target'] : $cta_target;
				}
				?>
				<a href="<?php echo esc_url($cta_url); ?>" class="sarathi-header-cta-btn"
