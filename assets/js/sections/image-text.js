document.addEventListener("DOMContentLoaded", () => {
    // Select all sections
    const sections = document.querySelectorAll(".why-choose-section");
    ...
    const updateImages = () => {
        ...
        sections.forEach((section) => {
            const images = section.querySelectorAll(".why-choose-image, .sarathi-imagetext-richtext-image");
            ...
            images.forEach((image) => {
                const container = image.closest(".why-choose-image-media, .why-choose-image-col, .sarathi-imagetext-richtext-image-col");
