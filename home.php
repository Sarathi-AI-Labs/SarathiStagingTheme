				...
				<div class="sarathi-inner-banner-text-content">
					<?php if ( ! empty( $hero_eyebrow ) ) : ?>
						<div class="sarathi-hero-eyebrow-wrapper">
							<p class="sarathi-hero-eyebrow"><?php echo esc_html( $hero_eyebrow ); ?></p>
							<span class="sarathi-hero-eyebrow-line"></span>
						</div>
					<?php endif; ?>

					<?php if ( ! empty( $hero_title_html ) ) : ?>
						<h1 class="sarathi-hero-heading"><?php echo wp_kses_post( $hero_title_html ); ?></h1>
					<?php endif; ?>

					<?php if ( ! empty( $hero_desc ) ) : ?>
						<div class="sarathi-hero-description"><p><?php echo esc_html( $hero_desc ); ?></p></div>
					<?php endif; ?>
				</div>
