...
<main id="primary" class="site-main sarathi-blog-archive">
	...
	<!-- 1. Blog Hero Header Section (Unified Inner Page Banner) -->
		...
		<div class="container sarathi-section-container">
			<div class="sarathi-inner-banner-wrapper">
				...
				<div class="sarathi-inner-banner-side-content type-form">
					<form role="search" method="get" class="sarathi-blog-filter-form"
						...
						<div class="sarathi-blog-cat-select-wrap">
							...
							<select name="cat" id="blog-cat-select" class="sarathi-blog-cat-select"
								aria-label="<?php esc_attr_e('Filter by category', 'custom-theme'); ?>">
								<option value="0">
							...
							<svg class="sarathi-select-arrow" viewBox="0 0 20 20" fill="currentColor"
								aria-hidden="true">
								<path fill-rule="evenodd"
