	...
	<header class="sarathi-hero-banner sarathi-inner-page-banner">
		<div class="container sarathi-section-container">
			<div class="sarathi-inner-banner-wrapper">
				...
				<!-- Right Column: Category Filter Tabs -->
				<div class="sarathi-inner-banner-side-content type-form">
					<?php if (!empty($categories) && !is_wp_error($categories)): ?>
						<nav class="sarathi-tr-filter-tabs"
							aria-label="<?php esc_attr_e('Training categories', 'custom-theme'); ?>">
							<a href="<?php echo esc_url(get_post_type_archive_link('training')); ?>"
								class="sarathi-tr-tab <?php echo 0 === $current_term_id ? 'is-active' : ''; ?>">
								<?php esc_html_e('All Trainings', 'custom-theme'); ?>
							</a>
							<?php foreach ($categories as $cat): ?>
								<a href="<?php echo esc_url(get_term_link($cat)); ?>"
									class="sarathi-tr-tab <?php echo $current_term_id === $cat->term_id ? 'is-active' : ''; ?>">
					...
					while (have_posts()):
						...
						<div class="sarathi-training-card">
							...
							<div class="sarathi-training-card__action">
								<a href="<?php echo esc_url($p_link); ?>" class="sarathi-training-btn-arrow"
									aria-label="<?php echo esc_attr(sprintf(__('View %s', 'custom-theme'), $p_title)); ?>">
