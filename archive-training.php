 ...
 *
 * Renders editable ACF Flexible Content sections configured in Trainings -> Archive Settings,
 * followed by the dynamic Trainings Grid.
 *
...
// Hook category filter tabs to hero side content
add_action( 'sarathi_inner_hero_side_content', function() use ( $categories, $current_term_id ) {
